#ifndef _ROS_SERVICE_GetCurrentModel_h
#define _ROS_SERVICE_GetCurrentModel_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETCURRENTMODEL[] = "uuv_world_ros_plugins_msgs/GetCurrentModel";

  class GetCurrentModelRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return GETCURRENTMODEL; };
    const char * getMD5(){ return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class GetCurrentModelResponse : public ros::Msg
  {
    public:
