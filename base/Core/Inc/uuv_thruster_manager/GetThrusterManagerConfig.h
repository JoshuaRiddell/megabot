...
static const char GETTHRUSTERMANAGERCONFIG[] = "uuv_thruster_manager/GetThrusterManagerConfig";
  ...
  class GetThrusterManagerConfigResponse : public ros::Msg
  {
    public:
      ...
      typedef double _allocation_matrix_type;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 4) = (u_max_thrust.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_max_thrust.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_max_thrust.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_max_thrust.base >> (8 * 7)) & 0xFF;
      ...
      *(outbuffer + offset + 3) = (this->allocation_matrix_length >> (8 * 3)) & 0xFF;
      ...
      union {
        double real;
        uint64_t base;
      } u_allocation_matrixi;
      u_allocation_matrixi.real = this->allocation_matrix[i];
      *(outbuffer + offset + 0) = (u_allocation_matrixi.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_allocation_matrixi.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_allocation_matrixi.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_allocation_matrixi.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_allocation_matrixi.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_allocation_matrixi.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_allocation_matrixi.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_allocation_matrixi.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->allocation_matrix[i]);
      }
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_max_thrust.base = 0;
      u_max_thrust.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_max_thrust.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_max_thrust.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_max_thrust.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_max_thrust.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_max_thrust.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_max_thrust.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_max_thrust.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      ...
      if(allocation_matrix_lengthT > allocation_matrix_length)
        this->allocation_matrix = (double*)realloc(this->allocation_matrix, allocation_matrix_lengthT * sizeof(double));
      allocation_matrix_length = allocation_matrix_lengthT;
      for( uint32_t i = 0; i < allocation_matrix_length; i++){
      union {
        double real;
        uint64_t base;
      } u_st_allocation_matrix;
      u_st_allocation_matrix.base = 0;
      u_st_allocation_matrix.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_st_allocation_matrix.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_st_allocation_matrix.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_st_allocation_matrix.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_st_allocation_matrix.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_st_allocation_matrix.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_st_allocation_matrix.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_st_allocation_matrix.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->st_allocation_matrix = u_st_allocation_matrix.real;
      offset += sizeof(this->st_allocation_matrix);
        memcpy( &(this->allocation_matrix[i]), &(this->st_allocation_matrix), sizeof(double));
      }
     return offset;
    }
