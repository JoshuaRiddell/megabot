  ...
  class InitHelicalTrajectoryRequest : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 7) = (u_duration.base >> (8 * 7)) & 0xFF;
      ...
      u_n_turns.real = this->n_turns;
      *(outbuffer + offset + 0) = (u_n_turns.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_n_turns.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_n_turns.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_n_turns.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_n_turns.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_n_turns.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_n_turns.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_n_turns.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->n_turns);
      union {
        double real;
        uint64_t base;
      } u_delta_z;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_n_turns.base = 0;
      u_n_turns.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_n_turns.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_n_turns.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_n_turns.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_n_turns.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_n_turns.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_n_turns.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_n_turns.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->n_turns = u_n_turns.real;
      offset += sizeof(this->n_turns);
      union {
        double real;
        uint64_t base;
