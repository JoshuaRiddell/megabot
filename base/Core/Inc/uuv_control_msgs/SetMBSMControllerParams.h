#ifndef _ROS_SERVICE_SetMBSMControllerParams_h
#define _ROS_SERVICE_SetMBSMControllerParams_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETMBSMCONTROLLERPARAMS[] = "uuv_control_msgs/SetMBSMControllerParams";

  class SetMBSMControllerParamsRequest : public ros::Msg
  {
    public:
    ...
    SetMBSMControllerParamsRequest():
    ...
    const char * getType(){ return SETMBSMCONTROLLERPARAMS; };
    const char * getMD5(){ return "7293aecc8487ffe3e998814d65aa6940"; };

  };

  class SetMBSMControllerParamsResponse : public ros::Msg
  {
    public:
      typedef bool _success_type;
      _success_type success;

    SetMBSMControllerParamsResponse():
      success(0)
    {
    }
